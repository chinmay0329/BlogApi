...
import com.code.blog.blog_apis.payloads.ApiResponse;
...
public class UserController 
{
	...
	{
		UserDto createdDtoUSer= userService.createUser(userDto);
//		System.out.println("**************************************************");
//		System.out.println(createdDtoUSer.getPassword());
	...
	@PutMapping("/{userId}") // this is path variable
